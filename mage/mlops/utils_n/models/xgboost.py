...
from mlops.utils_n.hyperparameters.sklearn import build_hyperparameter_space
...
def tune_hyperparameters(
    ...
    **kwargs
    ...
    space, choices = build_hyperparameter_space(Booster, random_state=random_state)
...
def load_model(model_dir:str, model_filaname:str, config_filename: str)->Booster:
    model_path = os.path.join(model_dir, model_filaname)
    model = Booster()
